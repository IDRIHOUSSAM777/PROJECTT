...
const TRANSLATIONS = {
  ...
  es: {
    ...
    'favorites.subtitle': 'Tus equipos guardados para acceder con un clic.',
    'favorites.empty': 'Aún no tienes favoritos.',
    'favorites.emptyHint': 'Haz clic en ⭐ en la ficha de un equipo para guardarlo aquí.',
    'favorites.browse': 'Explorar equipos',
    'favorites.added': 'Añadido',
    'favorites.remove': 'Quitar de favoritos',
    'favorites.removeConfirm': '¿Quitar este equipo de tus favoritos?',
    'favorites.open': 'Abrir ficha',
    'equipment.addFavorite': 'Añadir a favoritos',
    'equipment.removeFavorite': 'Quitar de favoritos',
    ...
    'map.title': 'Mapa Interactivo 2D',
    'map.subtitle': 'Localiza equipos en el plano del edificio.',
    'map.selectFloor': 'Selecciona un piso:',
    'map.noObjects': 'No se encontraron equipos en este piso.',
    'map.floor': 'Piso',
    ...
    'equipment.joinQueue': 'Unirse a la lista de espera',
    ...
    'auth.verifyEmail': 'Verificación de correo',
    'auth.code': 'Código de 6 dígitos',
    'auth.verify': 'Verificar',
    'auth.verifySuccess': 'Correo verificado con éxito. Ya puedes iniciar sesión.',
    'auth.verifyError': 'Error de verificación.',
    ...
    'support.subtitle': 'Envíe un problema o realice un seguimiento de sus solicitudes.',
    'support.newTicket': 'Nueva Solicitud',
    'support.subject': 'Asunto',
    'support.subjectPlaceholder': 'ej. Problema de conexión',
    'support.descPlaceholder': 'Describa su problema en detalle...',
    'support.submit': 'Enviar',
    'support.allTickets': 'Todas las solicitudes (Supervisión)',
    'support.myTickets': 'Mis solicitudes',
    'support.noTickets': 'Sin solicitudes por el momento.',
    'support.ticketCreated': '¡Solicitud creada con éxito!',
    'support.resolveConfirm': '¿Marcar esta solicitud como Resuelta?',
